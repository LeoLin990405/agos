...
八项任务书条目 + 验证过程中新暴露的三项。逐条给**判据**和**否证**——
「改了」不算完成，「改坏了会变红」才算。

- 基线：`9434064f87b1a936c13c58b94c2473c6d89f3a61`
- 交付：分支 `fix/cursor-integration-20260909` 尖端；**代码最后一跳 `d60ae14`**，其后各跳只动 `docs/`
...
| 主控（本文件作者） | `scripts/acceptance`、依赖清单与锁文件、`frontend` 宿主联测、Fleet、各插件 `index.js`、集成文档 | `b067830`、`d60ae14` |
